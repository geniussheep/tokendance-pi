...
function normalizeProviderAllowlist(providerAllowlist) {
    return providerAllowlist === undefined ? undefined : new Set(providerAllowlist);
}
function isProviderAllowed(providerAllowlist, providerId) {
...
export class ModelRuntime {
    ...
    constructor(credentials, config, modelsPath, modelsStore, providers, modelNetworkEnabled, providerAllowlist) {
    ...
    static async create(options = {}) {
        ...
        const runtime = new ModelRuntime(credentials, config, modelsPath, modelsStore, providers, process.env.PI_OFFLINE === undefined, providerAllowlist);
